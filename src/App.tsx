...
function App() {
  ...
  return (
    <div className="app-shell">
      {/* EA FC 27-style top navigation bar */}
      <header className="app-topnav">
        <div className="app-topnav-logo">
          <div className="hex-badge">FC</div>
  ...
  return <div className="landing-shell">
    <nav className="landing-nav">
      <div className="landing-logo">
        <div className="landing-logo-icon">FC</div>
        <div className="landing-logo-text">EA SPORTS<span> FC</span></div>
      </div>
    ...
    <main className="landing-hero">
      <div className="eyebrow"><i /> EA SPORTS FC · CAREER MODE</div>
